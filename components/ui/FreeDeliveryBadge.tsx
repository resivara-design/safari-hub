...
export default function FreeDeliveryBadge({ className = "" }: FreeDeliveryBadgeProps) {
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-full bg-deep-green px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide text-cream ${className}`}
    >
